...
\restrict zve1qreJ1Tpwl91RpIyOFdYecYv5IhGbhy69pL0RpFgffAE9yTGYXmfRiBKoseq
...
CREATE TABLE public.finanzas_categorias (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT finanzas_categorias_tipo_check CHECK (((tipo)::text = ANY (ARRAY[('ingreso'::character varying)::text, ('gasto'::character varying)::text])))
);
...
CREATE TABLE public.finanzas_cuentas (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT finanzas_cuentas_tipo_check CHECK (((tipo)::text = ANY (ARRAY[('efectivo'::character varying)::text, ('banco'::character varying)::text, ('tarjeta_credito'::character varying)::text, ('ahorro'::character varying)::text])))
);
...
CREATE TABLE public.finanzas_deudas (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT finanzas_deudas_estado_check CHECK (((estado)::text = ANY (ARRAY[('pendiente'::character varying)::text, ('pagando'::character varying)::text, ('completada'::character varying)::text])))
);
...
CREATE TABLE public.finanzas_metas (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT finanzas_metas_estado_check CHECK (((estado)::text = ANY (ARRAY[('en_progreso'::character varying)::text, ('completada'::character varying)::text, ('fallida'::character varying)::text])))
);
...
CREATE TABLE public.finanzas_transacciones (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT finanzas_transacciones_tipo_check CHECK (((tipo)::text = ANY (ARRAY[('ingreso'::character varying)::text, ('gasto'::character varying)::text, ('transferencia'::character varying)::text])))
);
...
--
-- Name: meta_progreso_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: meta_progreso_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.metas (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT metas_estado_check CHECK (((estado)::text = ANY ((ARRAY['borrador'::character varying, 'en_progreso'::character varying, 'completada'::character varying, 'cancelada'::character varying])::text[])))
);
...
--
-- Name: plantillas_bloques; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.recordatorios (
    ...
    creado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    actualizado_en timestamp without time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT recordatorios_estado_check CHECK (((estado)::text = ANY (ARRAY[('pendiente'::character varying)::text, ('enviado'::character varying)::text, ('cancelado'::character varying)::text, ('fallido'::character varying)::text]))),
    CONSTRAINT recordatorios_regla_recurrencia_check CHECK (((regla_recurrencia)::text = ANY (ARRAY[('diario'::character varying)::text, ('semanal'::character varying)::text, ('mensual'::character varying)::text, (NULL::character varying)::text]))),
    CONSTRAINT recordatorios_tipo_check CHECK (((tipo)::text = ANY (ARRAY[('agenda'::character varying)::text, ('habito'::character varying)::text, ('manual'::character varying)::text, ('push'::character varying)::text, ('whatsapp'::character varying)::text, ('email'::character varying)::text])))
);
...
CREATE TABLE public.tareas (
    ...
    dias_semana jsonb DEFAULT '[]'::jsonb,
    CONSTRAINT tareas_recurrencia_check CHECK (((recurrencia)::text = ANY (ARRAY[('diario'::character varying)::text, ('semanal'::character varying)::text, ('mensual'::character varying)::text])))
);
...
--
-- Name: meta_progreso id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: meta_progreso meta_progreso_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meta_progreso meta_progreso_unique; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques plantillas_bloques_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia plantillas_dia_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia plantillas_dia_usuario_id_dia_semana_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_amistades_estado; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_amistades_estado ON public.amistades USING btree (estado);


--
-- Name: idx_amistades_receptor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_amistades_receptor ON public.amistades USING btree (receptor_id);


--
-- Name: idx_amistades_solicitante; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_amistades_solicitante ON public.amistades USING btree (solicitante_id);
...
--
-- Name: idx_bloques_tiempo_usuario; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_bloques_tiempo_usuario ON public.bloques_tiempo USING btree (usuario_id);
...
--
-- Name: idx_ejercicios_rutina; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_ejercicios_rutina ON public.ejercicios USING btree (rutina_id);
...
--
-- Name: idx_meta_progreso_fecha; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_meta_progreso_fecha ON public.meta_progreso USING btree (fecha DESC);
...
--
-- Name: idx_plantillas_bloques_plantilla; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plantillas_bloques_plantilla ON public.plantillas_bloques USING btree (plantilla_id);


--
-- Name: idx_plantillas_dia_usuario; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_plantillas_dia_usuario ON public.plantillas_dia USING btree (usuario_id);
...
--
-- Name: idx_rutinas_usuario; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_rutinas_usuario ON public.rutinas USING btree (usuario_id);
...
--
-- Name: idx_tareas_auto_programado; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tareas_auto_programado ON public.tareas USING btree (auto_programado) WHERE (auto_programado = true);
...
--
-- Name: idx_tareas_key_result_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tareas_key_result_id ON public.tareas USING btree (key_result_id);


--
-- Name: idx_tareas_meta_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tareas_meta_id ON public.tareas USING btree (meta_id);
...
--
-- Name: idx_tareas_usuario_estado; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tareas_usuario_estado ON public.tareas USING btree (usuario_id, estado);


--
-- Name: idx_tareas_usuario_fecha_inicio; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_tareas_usuario_fecha_inicio ON public.tareas USING btree (usuario_id, fecha_inicio);
...
--
-- Name: key_results_meta_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: metas_usuario_id_index; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: amistades trigger_amistades_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_amistades_updated BEFORE UPDATE ON public.amistades FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: bloques_tiempo trigger_bloques_tiempo_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_bloques_tiempo_updated BEFORE UPDATE ON public.bloques_tiempo FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();
...
--
-- Name: checkins_emocionales trigger_checkins_emocionales_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_checkins_emocionales_updated BEFORE UPDATE ON public.checkins_emocionales FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: comentarios trigger_comentarios_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_comentarios_updated BEFORE UPDATE ON public.comentarios FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: diario_personal trigger_diario_personal_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_diario_personal_updated BEFORE UPDATE ON public.diario_personal FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: ejercicios trigger_ejercicios_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_ejercicios_updated BEFORE UPDATE ON public.ejercicios FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: eventos_gamificacion trigger_eventos_gamificacion_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_eventos_gamificacion_updated BEFORE UPDATE ON public.eventos_gamificacion FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_categorias trigger_finanzas_categorias_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_categorias_updated BEFORE UPDATE ON public.finanzas_categorias FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_cuentas trigger_finanzas_cuentas_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_cuentas_updated BEFORE UPDATE ON public.finanzas_cuentas FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_deudas trigger_finanzas_deudas_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_deudas_updated BEFORE UPDATE ON public.finanzas_deudas FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_metas trigger_finanzas_metas_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_metas_updated BEFORE UPDATE ON public.finanzas_metas FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_presupuestos trigger_finanzas_presupuestos_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_presupuestos_updated BEFORE UPDATE ON public.finanzas_presupuestos FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: finanzas_transacciones trigger_finanzas_transacciones_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_finanzas_transacciones_updated BEFORE UPDATE ON public.finanzas_transacciones FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();
...
--
-- Name: key_results trigger_key_results_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_key_results_updated BEFORE UPDATE ON public.key_results FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: metas trigger_metas_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_metas_updated BEFORE UPDATE ON public.metas FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: pomodoro_sessions trigger_pomodoro_sessions_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_pomodoro_sessions_updated BEFORE UPDATE ON public.pomodoro_sessions FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: registros_entrenamiento trigger_registros_entrenamiento_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_registros_entrenamiento_updated BEFORE UPDATE ON public.registros_entrenamiento FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();


--
-- Name: rutinas trigger_rutinas_updated; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trigger_rutinas_updated BEFORE UPDATE ON public.rutinas FOR EACH ROW EXECUTE FUNCTION public.actualizar_timestamp();
...
--
-- Name: eventos_gamificacion eventos_gamificacion_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.eventos_gamificacion
    ADD CONSTRAINT eventos_gamificacion_usuario_id_fkey FOREIGN KEY (usuario_id) REFERENCES public.usuarios(id) ON DELETE CASCADE;
...
--
-- Name: key_results key_results_meta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: meta_progreso meta_progreso_meta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques plantillas_bloques_gimnasio_rutina_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_bloques plantillas_bloques_plantilla_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: plantillas_dia plantillas_dia_usuario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tareas tareas_key_result_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tareas tareas_meta_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
