...
import { categoriasHabitosRouter } from './modules/categorias_habitos/categorias_habitos.routes.js';
...
app.use('/api/categorias-habitos', categoriasHabitosRouter);
categoriasHabitosRouter.prefix = '/api/categorias-habitos';
